...
RSpec.describe Noventius::FiltersHelper do

  before { helper.extend Noventius::ApplicationHelper }

  it { should be_a(Noventius::FilterWrappers) }

  Noventius::Filter::TYPES.each do |filter_type|
